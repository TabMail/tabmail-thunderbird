...
- Download-page deep-link target `tabmail.ai/download#fts-helper` is the FTS Helper tab (see `PLAN_ATN_DISTRIBUTION.md` §1.6 / Phase 2). Tests: `test/icon.test.js` (`setActionWarning` icon-swap cases).
